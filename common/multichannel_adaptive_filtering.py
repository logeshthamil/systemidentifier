...
def siso_nlms_multichannel(input_signals_array, desired_output, filter_length, step_size, eps=0.001, leak=0,
                           initCoeffs=None):
    """
...
def miso_nlms_multichannel(input_signals_array, desired_output, filter_length, step_size, eps=0.001, leak=0,
                           initCoeffs=None):
    """
