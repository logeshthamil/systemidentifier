...
def test_identify_a_HGM_clippingvsclippingadaptive():
    ...
    black_box = nlsp.HammersteinGroupModel(nonlinear_functions=nonlinear_functions,
                                           aliasing_compensation=aliasing_compensation,
                                           filter_impulseresponses=linear_filters)
    identification_algorithm_clippingadaptive = nlsp.system_identification.ClippingAdaptive(select_branches=select_branches,
                                                                           excitation_length=excitation_length,
                                                                           nonlinear_function=nlsp.nonlinear_function.HardClip,
    ...
    evaluation_adaptive = nlsp.evaluations.CompareWithReference(black_box.GetOutput(), model_black_box_adaptive.GetOutput())
    evaluation_clippingadaptive = nlsp.evaluations.CompareWithReference(black_box.GetOutput(), model_black_box_clippingadaptive.GetOutput())
