...
def test_MISO_NLMS_multichannel_algorithm():
    sampling_rate = 48000
    length = 2**15
    branches = 2
    ...
    adaptation_algorithm = nlsp.MISO_NLMS_multichannel_algorithm(input_signal=outputs, filter_length=len(linear_kernels[0]),
